## trace/script not support simple namespace, bad!!
...
dummy_int_input = 3  # An integer input
dummy_tensor_input = torch.zeros(120, 1024, dtype=torch.float32)
...
# # Trace the model
# traced_model = torch.jit.trace(model, (dummy_int_input, dummy_tensor_input))
